        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EffectKey = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GameActionLogs_Matches_MatchId",
                        column: x => x.MatchId,
                        principalTable: "Matches",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GameActionLogs_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GameActionLogs_MatchId_IdempotencyKey",
                table: "GameActionLogs",
                columns: new[] { "MatchId", "IdempotencyKey" },
                unique: true,
                filter: "[IdempotencyKey] IS NOT NULL");

            migrationBuilder.CreateIndex(
                name: "IX_GameActionLogs_UserId",
                table: "GameActionLogs",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_Matches_SessionToken",
                table: "Matches",
                column: "SessionToken",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_MatchPlayers_MatchId_SeatIndex",
                table: "MatchPlayers",
                columns: new[] { "MatchId", "SeatIndex" },
                unique: true);
